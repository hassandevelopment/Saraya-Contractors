    ...
    <>
      ...
      <section className="py-16 lg:py-20 bg-navy-900">
        <div className="max-w-content mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 md:divide-x md:divide-navy-700">
      ...
      <section className="py-20 lg:py-28 bg-sand-50">
        <div className="max-w-content mx-auto px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-navy-900 tracking-tight mb-3">
                {t.home.projects.heading}
              </h2>
              <p className="text-navy-600">{t.home.projects.subheading}</p>
            </div>
            <Link
              href={`${base}/projects`}
        ...
        <div className="max-w-content mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-navy-900 tracking-tight leading-snug mb-6 whitespace-pre-line">
              ...
              <Link
                href={`${base}/about`}
                className="inline-flex items-center gap-2 border border-navy-700/30 hover:border-navy-900 text-navy-800 font-semibold px-6 py-3 transition-all duration-150"
              >
                {t.home.about.cta}
                <ArrowRight size={15} />
              </Link>
      ...
      {/* Final CTA */}
      <section className="py-20 lg:py-24 bg-navy-800">
        <div className="max-w-content mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight mb-4">
            {t.home.cta.heading}
          </h2>
          <p className="text-sand-300 text-lg mb-8 max-w-xl mx-auto">
            {t.home.cta.description}
          </p>
          <Link
            href={`${base}/contact`}
            className="inline-flex items-center gap-2 bg-terra-500 hover:bg-terra-600 text-white font-semibold px-8 py-4 transition-colors duration-150"
          >
            {t.home.cta.cta}
            <ArrowRight size={16} />
          </Link>
